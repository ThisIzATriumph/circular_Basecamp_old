    ...
    <Layout site={site}>
      ...
      >
        ...
        <div className="filterSection">
          {/* <svg width="200px" height="30px" css={css`margin: 0 auto;`}><rect fill={theme.colors.pink} width="200px" height="1px" /></svg> */}
...
export const AtelierPageQuery = graphql`
  query {
    site {
      ...site
      siteMetadata {
